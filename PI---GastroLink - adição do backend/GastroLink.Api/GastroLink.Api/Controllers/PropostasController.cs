...
namespace GastroLink.Api.Controllers
{
     ...
     public class PropostasController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create(PropostaCreateDto dto)
        {
            ...
            var restauranteExiste = await _context.Restaurantes.AnyAsync(r => r.Id == dto.RestauranteId);
            if (!restauranteExiste)
                return NotFound("O restaurante selecionado não existe na base de dados.");
